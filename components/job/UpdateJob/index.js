...
import { jobTypesOptions, industryOptions, educationOptions, experienceOptions } from "../data";

const NewJob = ({ job, access_token }) => {
            ...
            <div className="col-12 col-md-6 ml-4 mt-4 mt-md-0 ml-md-0">
              <div className="boxWrapper">
                ...
                <div className="selectWrapper">
                  ...
                  >
                    {jobTypesOptions.map((opt) => <option key={opt} value={opt}>{ opt }</option>)}
                  </select>
                </div>
              </div>
